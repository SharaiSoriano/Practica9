...
public class App {
    ...
    Mini_Robot_Dos_Cuchillos R1 = new Mini_Robot_Dos_Cuchillos();
    
    Mini_Robot_Manos_Calientes R2 = new Mini_Robot_Manos_Calientes();
    ...
    do{
        ...
        accion = 0;
    do{
        System.out.println("Elige que desea comer:");
        
        System.out.println("1) Desayuno " );
        System.out.println("2) Comida " );
        System.out.println("3) Cena");
        op = CapturaEntrada.capturaEntero();
    ...
    if(R1.getAccion() == null && R2.getAccion() == null){
        System.out.println("Magnum Opus realizo todo con normalidad!");
    }
    ...
    System.out.println("Buen trabajo!");
        ...
        System.out.println("Mmm...le falto algo!");
    }
    }
    else if(R1.getAccion() == null && R2.getAccion() !=null){
    ...
    System.out.println("No quedo como deberia");
    }
        opus.Imprimir();
        R1.Imprimir();
        R2.Imprimir();
